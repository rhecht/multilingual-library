...
<div class="page-head">
    <h1 class="page-title"><?php echo lang('Category Entry');?><small>add a new entry</small></h1>        
</div>
	...
	<div class="col-lg-6 form-horizontal">
		...
		<div class="form-row">            			                        
			<div class="form-group">
    			...
    			<div class="col-sm-9">
                    <input type="text" class="form-control" id="language" name="language" value="<?php echo set_value('language');?>" required/>
                </div>
			</div>                  			
		</div>
		<div class="form-row">        			
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <input type="text" class="form-control" id="language_he" name="language_he" value="<?php echo set_value('language_he');?>" required/>
                </div>
			</div>        			
		</div>		
		<div class="form-row">        			
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <input type="text" class="form-control" id="language_es" name="language_es" value="<?php echo set_value('language_es');?>" required/>
                </div>
			</div>        			
		</div>	
		<div class="form-row">        			
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <input type="text" class="form-control" id="language_fr" name="language_fr" value="<?php echo set_value('language_fr');?>" required/>
                </div>
			</div>        			
		</div>	
		<div class="form-row">        			
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <input type="text" class="form-control" id="language_ru" name="language_ru" value="<?php echo set_value('language_ru');?>" required/>
                </div>
			</div>        			
		</div>	
