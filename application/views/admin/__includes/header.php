	...
	<!-- BEGIN HEADER -->
	<header>
		<a href="<?php echo site_url('admin');?>" class="logo"><i class="ion-ios-bolt"></i> <span>Tekhelet</span></a>
		<nav class="navbar navbar-static-top">
			...
			<div class="navbar-header">
				<ul class="nav navbar-nav pull-left">
					<li><a href="#"><i class="ion-arrow-person-add"></i></a></li>
					<?php /* removed for now 
					...
					<li class="dropdown dropdown-inverse">
						...
						<ul class="dropdown-menu">
							<li>
								<a href="#"><i class="ion-compose"></i> New Article </a>
							</li>
                                ...
                                <ul class="media-list media-content scroll">
									<li class="media">
										<a class="pull-left" href="#">
											<img class="media-object img-circle width-40 height-40" src="<?php echo $this->config->item('admin_theme') ?>/img/avatar.jpg" alt="image">
										</a>
									...
									<li class="media">
										<a class="pull-left" href="#">
											<img class="media-object img-circle width-40 height-40" src="<?php echo $this->config->item('admin_theme') ?>/img/avatar_3.jpg" alt="image">
										</a>
										<div class="media-body">
											<div class="clearfix">
									...
									<li class="media">
										<a class="pull-left" href="#">
											<img class="media-object img-circle width-40 height-40" src="<?php echo $this->config->item('admin_theme') ?>/img/avatar_2.jpg" alt="image">
										</a>
										<div class="media-body">
											<div class="clearfix">
									...
									<li class="media">
										<a class="pull-left" href="#">
											<img class="media-object img-circle width-40 height-40" src="<?php echo $this->config->item('admin_theme') ?>/img/avatar_4.jpg" alt="image">
										</a>
										<div class="media-body">
											<div class="clearfix">
	...
	<!-- END HEADER -->
    <?php $this->view('admin/__includes/sidebar-left');?>
