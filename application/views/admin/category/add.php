	...
	<div class="col-lg-6 form-horizontal">
		...
		<div class="form-row">        			
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <input type="text" class="form-control" id="category_he" name="category_he" value="<?php echo set_value('category_he');?>" required/>
                </div>
			</div>        			
		</div>
		<div class="form-row">        			
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <input type="text" class="form-control" id="category_es" name="category_es" value="<?php echo set_value('category_es');?>" required/>
                </div>
			</div>        			
		</div>			
		<div class="form-row">        			
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <input type="text" class="form-control" id="category_fr" name="category_fr" value="<?php echo set_value('category_fr');?>" required/>
                </div>
			</div>        			
		</div>			
		<div class="form-row">        			
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <input type="text" class="form-control" id="category_ru" name="category_ru" value="<?php echo set_value('category_ru');?>" required/>
                </div>
			</div>        			
		</div>			
