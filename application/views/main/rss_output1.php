...
<?php foreach ($records as $key => $items): ?>
	<item>
	    ...
	    <source url="<?php echo urlencode($items->URL) ?>"><![CDATA[<?php echo xml_convert($items->Publication);?>]]></source>
		<?php /*<atom:link href="<?php echo site_url('rss') ?>" rel="self" type="application/rss+xml" />*/?>
	    <link><?php echo urlencode($items->URL); ?></link>
	    <guid><?php echo urlencode($items->URL); ?></guid>
	    <mediatype><?php echo $items->Media; ?></mediatype>
